...
6. 启动nexus容器，对于以后的容器启动，[不清楚如何启动可以去docker hub 查看][https://hub.docker.com/]，
    ...
    ![](../img/17-9-14/58578914.jpg)
    
7. 一般直接搜索`run `就可以找到如何启动

    ![](../img/17-9-14/87774408.jpg)
    
8. 访问查看，管理员账户密码 `admin admin123`

    ![](../img/17-9-14/45145189.jpg)
    
9. maven设置

    * setting.xml设置
        ![](../img/17-9-14/65102103.jpg)
        
    * pom文件设置
        ![](../img/17-9-14/12953066.jpg)
        ![](../img/17-9-14/81818372.jpg)
